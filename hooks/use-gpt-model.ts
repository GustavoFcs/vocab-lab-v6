...
export type GptModel = "openai/gpt-4o-mini" | "openai/gpt-5-nano" | "openai/gpt-5.4-mini"
...
export function useGptModel() {
  ...
  useEffect(() => {
    ...
    if (saved) {
      ...
      if (saved === "gpt-5.4-mini-2026-03-17" || saved === "gpt-5.4-mini") normalized = "openai/gpt-5.4-mini"

      if (normalized === "openai/gpt-4o-mini" || normalized === "openai/gpt-5-nano" || normalized === "openai/gpt-5.4-mini") {
